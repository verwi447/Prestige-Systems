...
const MyCompanyModals = lazy(() => import("./MyCompanyModals"));
...
export default function MyCompany() {
  ...
  return (
    <div className="page my-company-page">
      ...
      {(editCompanyOpen || employeeOpen || resetEmployee || assignEmployee || siteOpen || assignSite) && (
        <Suspense fallback={null}>
          <MyCompanyModals
            ...
            saveEmployeeSites={saveEmployeeSites}
            employeeSiteQuery={employeeSiteQuery}
            setEmployeeSiteQuery={setEmployeeSiteQuery}
            employeeSites={employeeSites}
            setEmployeeSites={setEmployeeSites}
            siteOpen={siteOpen}
            setSiteOpen={setSiteOpen}
            siteForm={siteForm}
            setSiteForm={setSiteForm}
            saveSite={saveSite}
            siteImageError={siteImageError}
            setSiteImage={setSiteImage}
            removeSiteImage={removeSiteImage}
            assignSite={assignSite}
            setAssignSite={setAssignSite}
            saveAssignedUsers={saveAssignedUsers}
            employees={employees}
