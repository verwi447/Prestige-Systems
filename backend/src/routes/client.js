...
router.get("/account/notification-preferences", async (req, res) => {
  const result = await db.query(
...
router.put("/account/notification-preferences", async (req, res) => {
  const values = {
...
router.get("/account/sessions", (_req, res) => {
  res.json([]);
});

router.delete("/account/sessions/:id", (_req, res) => {
